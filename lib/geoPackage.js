...
var SpatialReferenceSystemDao = require('./core/srs').SpatialReferenceSystemDao
  ...
  , VTStylesDao = require('./extension/vt').VTStylesDao
  , VTStylesTable = require('./extension/vt').VTStylesTable 
  , VTSymbolsDao = require('./extension/vt').VTSymbolsDao
  , VTSymbolsTable = require('./extension/vt').VTSymbolsTable ;
...
GeoPackage.prototype.getVTLayersDao = function () {
  var vtLayerTable = new VTLayersTable();
  return new VTLayersDao(this, vtLayerTable);
};

GeoPackage.prototype.getVTStylesDao = function () {
  var vtStylesTable = new VTStylesTable();
  return new VTStylesDao(this, vtStylesTable);
};

GeoPackage.prototype.getVTSymbolsDao = function () {
  var vtSymbolsTable = new VTSymbolsTable();
